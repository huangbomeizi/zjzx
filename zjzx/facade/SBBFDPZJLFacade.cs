...
{
    public class SBBFDPZJLFacade
    {
        private static readonly SBBFDPZJLDao dao = new SBBFDPZJLDao();
        public bool add(SBBFDPZJL entity)
        {
        ...
        public bool update(SBBFDPZJL entity)
        {
